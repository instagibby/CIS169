...
namespace M11_Davis_EmployeeSearchProgram.EmployeeDataSetTableAdapters {
...
SELECT EmployeeID, Name, Position, HourlyPayRate FROM Employee WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::M11_Davis_EmployeeSearchProgram.Properties.Settings.Default.EmployeeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT EmployeeID, Name, Position, HourlyPayRate FROM dbo.Employee WHERE Name Lik" +
                "e \'%\' + @value + \'%\'";
